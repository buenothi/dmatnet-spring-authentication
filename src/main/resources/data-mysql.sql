INSERT IGNORE INTO `tbl_state` (`id`, `state_name`, `state_acronym`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
INSERT IGNORE INTO `tbl_city` (`id`, `city_name`, `state_id`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT IGNORE INTO `tbl_address_type` (`id_address_type`, `address_acronym`, `address_name`) VALUES
(1, 'A', 'Área'),
(2, 'AC', 'Acesso'),
(3, 'ACA', 'Acampamento'),
(4, 'ACL', 'Acesso Local'),
...
INSERT IGNORE INTO `tbl_telephone_type` (`id_telephone_type`,`type`) VALUES (1,'Comercial');
INSERT IGNORE INTO `tbl_telephone_type` (`id_telephone_type`,`type`) VALUES (2,'Celular');
INSERT IGNORE INTO `tbl_telephone_type` (`id_telephone_type`,`type`) VALUES (3,'Residencial');
INSERT IGNORE INTO `tbl_telephone_type` (`id_telephone_type`,`type`) VALUES (4,'WhatsApp');
INSERT IGNORE INTO `tbl_telephone_type` (`id_telephone_type`,`type`) VALUES (5,'Radio');