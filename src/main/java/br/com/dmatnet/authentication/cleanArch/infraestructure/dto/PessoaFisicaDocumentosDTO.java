package br.com.dmatnet.authentication.cleanArch.infraestructure.dto;
...
@NoArgsConstructor
@EqualsAndHashCode
public class PessoaFisicaDocumentosDTO implements Serializable, Cloneable {
    ...
    @Override
    public PessoaFisicaDocumentosDTO clone() throws CloneNotSupportedException {
        return (PessoaFisicaDocumentosDTO) super.clone();
    }
